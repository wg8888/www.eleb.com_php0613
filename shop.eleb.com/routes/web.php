...
Route::domain('shop.eleb.com')->group(function(){
    ...
    //添加地址
    Route::post('addresse/Add','address\AddresseController@Add');
    //显示添加地址
    Route::get('addresse/List','address\AddresseController@List');
    //修改回显
    Route::get('addresse/HuiXian','address\AddresseController@HuiXian');
    //修改添加地址
    Route::post('addresse/Edit','address\AddresseController@Edit');
    //获得订单列表接口
    Route::get('cart/CartList','car\CartController@CarList');
