window.api = {
  // 登录验证接口
  loginCheck: 'http://www.eleb.com/member/Login',
  // 获取短信验证码接口
  sms: 'http://www.eleb.com/member/Sms',
  // 注册接口
  regist: 'http://www.eleb.com/member/Begister',
  // 修改密码接口
  ...
  // 获得指定商家接口
  business: 'http://www.eleb.com/shop/Business',
  // 保存购物车接口
  addCart: '/addCart.php',
  // 获取购物车数据接口
  cart: '/cart.php',
